...
Use `docs/RELEASE_NOTES_TEMPLATE.md` for release notes, `docs/VERSIONING.md` for tag guidance, and `docs/DEPLOY_ROLLBACK_CHECKLIST.md` for deploy or rollback operations.
